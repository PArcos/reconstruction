...
![Problem data](/docs/problem-data.jpg) ![Reconstructed data](/docs/reconstructed.png) ![Postprocessed data](/docs/postprocessed.png)
...
* **Detect salient object** to remove unwanted parts of the mesh, we can use this paper [U2Net](https://github.com/xuebinqin/U-2-Net)
